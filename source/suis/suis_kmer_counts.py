...
if __name__ == '__main__':
	...
	genome_list = os.listdir("suis_biovar_files/jellyfish/")
	total = len(genome_list)

	# Creating a dict of all the kmers in the master file
	for record in SeqIO.parse("suis_biovar_files/j_all_suis.fna", "fasta"):
	...
	def kmer_check(genome):
		location = "suis_biovar_files/jellyfish/"+genome
	...
	df.to_csv("suis_biovar_files/Suis_Kmer_Counts.csv")
