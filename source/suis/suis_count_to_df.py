...
if __name__ == '__main__':
	...
	genome_list = os.listdir("suis_jellyfish_output/")
	total = len(genome_list)

	# Creating a dict of all the kmers in the master file
	for record in SeqIO.parse("j_all_suis.fna", "fasta"):
	...
	def kmer_check(genome):
		location = "suis_jellyfish_output/"+genome
	...
	df.to_csv("suis_kmer_counts.csv")
